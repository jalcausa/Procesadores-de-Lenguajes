...
public class Matrices {
    ...
    public final static String ERROR_SUMA_VEC    = "ERROR10: La operacion de suma entre vectores requiere que tengan la misma dimension";
    ...
    public static ArrayList<Double> concatena(ArrayList<Double> vector1, ArrayList<Double> vector2) {
    	return toArrayList( concatena(toVector(vector1), toVector(vector2)) );
    }
     ...
     * @param vector2
     */
    public static double[] union(double[] vector1, double[] vector2) {
    	double[] salida = concatena(vector1,vector2);
        return toSet(salida);			
    }

    public static ArrayList<Double> union(ArrayList<Double> vector1, ArrayList<Double> vector2) {
    	ArrayList<Double> salida = concatena(vector1,vector2);
        return toSet(salida);			
    }
    
    public static double[] union(double[] vector, double numero) {
    	double[] salida = concatena(vector,numero);
        return toSet(salida);			
    }
    
    public static double[] union(double numero, double[] vector ) {
    	double[] salida = concatena(numero,vector);
        return toSet(salida);			
    }
     ...
     * @param vector2
     */
    public static double[] interseccion(double[] vector1, double[] vector2) {
    	TreeSet<Double> set1 = toTreeSet(vector1);
    	TreeSet<Double> set2 = toTreeSet(vector2);
    	TreeSet<Double> ts = new TreeSet<Double>();
    	ts.addAll(set1);
    	ts.retainAll(set2);
    	double[] salida = toSet(ts);
        return salida;			
    }

    public static ArrayList<Double> interseccion(ArrayList<Double> set1, ArrayList<Double> set2) {
    	double[] salida = interseccion(toVector(set1),toVector(set2));
        return toArrayList(toSet(salida));			
    }
    ...
    /**
     * Imprime un vector o un conjunto
     * @param vector
     */
     ...
     * @param matriz
     */
    public static double[][] toMatriz(ArrayList<ArrayList<Double>> arrayList) {
    ...
    /**
     * Convierte un ArrayList<Double> en una matriz de 1 x n
     * @param vector
     */
    // public static double[][] toMatriz(ArrayList<Double> arrayList) {
    //	return toMatriz(toVector(arrayList));
    // }
    ...
    /**
     * Convierte un ArrayList<Double> en una conjunto de tipo ArrayList<Double>
     * @param arrayList
     */
    public static ArrayList<Double> toSet(ArrayList<Double> arrayList) {
    	TreeSet<Double> ts = toTreeSet(arrayList);
    	return toArrayList(toSet(ts));
    }
    
    /**
     * Convierte un double[] en una conjunto de tipo double[]
     * eliminando los elementos duplicados
     * @param arrayList
     */
    public static double[] toSet(double[] vector) {
    	TreeSet<Double> ts = toTreeSet(vector);
    	return toSet(ts);
    }

    private static double[] toSet(TreeSet<Double> ts) {
    	double[] salida = new double[ts.size()];
    	int i=0;
    	for(Double d : ts) {
    		salida[i++] = d;
    	}
    ...
    /*   toTreeSet                                 */
    /* ********************************************* */    
    private static TreeSet<Double> toTreeSet(double[] vector) {
    	TreeSet<Double> ts = new TreeSet<Double>();
    	for(int i=0; i<vector.length; i++) {
    		ts.add(vector[i]);
    	}
    ...
    private static TreeSet<Double> toTreeSet(ArrayList<Double> arrayList) {
    	return toTreeSet(toVector(arrayList));
    }
