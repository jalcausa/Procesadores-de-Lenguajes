...
public class MENOS extends EXPRESION{
    ...
    public void gc(){
        ...
        //se toma tk = ti-tj;
        if(this.izq == null){
            Generador.resta(this.getTemp(), "0", ((EXPRESION)this.dcha).getTemp(), this.getTipo());
        } else {
            Generador.resta(this.getTemp(), ((EXPRESION)this.izq).getTemp(), ((EXPRESION)this.dcha).getTemp(), this.getTipo());
        }
    }
