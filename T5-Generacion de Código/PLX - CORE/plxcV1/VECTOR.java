...
public class VECTOR extends EXPRESION{
    ...
    public VECTOR(){
        ...
        //this.temp no sera asignado aun
        //aun no podemos asignar el subtipo this.setsubtipo(0);
        //como es vacio, de momento asignamos tamaño 0, aunque ya se hace en super this.setTam(0);
    }
    ...
    public void anyadir(EXPRESION e){
        ...
        //Añadimos el resto de elementos comprobando tipos y actualizamos el tamaño.
            ...
            if(this.getSubtipo()==e.getSubtipo()){
                this.elementos.add(e); 
     ...
     */
    public void gc(){
        for(EXPRESION e : this.elementos){
            e.gc();
        }
    }
