...
public class Generador {
    ...
    public static final String E_NOBOOLEAN   = "# No es una condicion";
    public static final String E_PACKAGE     = "# Paquete incorrecto";
    public static final String E_IMPORT      = "# Importacion indevida";
    public static final String E_CCOMENT     = "# Comentario mal formado";
    ...
    /**
     * Metodo empleado para la impresion de comentarios en CTD
     * @param st comentario a imprimir
     * 
     * CTD: # st
     */
    public static void comentario(String st){
