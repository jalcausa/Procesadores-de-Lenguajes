/**
 * Clase IMPLICA que extiende de CONDICION y representa precisamente la operacion de implicacion entre 
 * dos condiciones.
 * izq: CONDICION condicion1
 * dcha: CONDICION condicion2
 * etiquetas: etiquetas correspondientes a la condicion
 * IMPLICA :: condicion1 --> condicion2
 */
public class IMPLICA extends CONDICION {
     ...
     */
    public IMPLICA(EXPRESION izq, EXPRESION dcha){
        super(izq, dcha);
     ...
     * Lf1: goto Lt2
     * 
     * Después asignamos a la condicion IMPLICA que tenga como ett el valor de lt2 y etf lf2
     */
    public void gc(){
