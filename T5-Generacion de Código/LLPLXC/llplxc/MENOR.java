/*
 * MENOR.java
 * Clase que representa la comparación menor que (<)
 */
...
public class MENOR extends CONDICION {
     ...
     * Constructor
     */
    public MENOR(EXPRESION op1, EXPRESION op2) {
        super(null, null);
        this.operando1 = op1;
        this.operando2 = op2;
    }
    ...
    /*
     * Genera código para la comparación menor que
     */
    @Override
    public void generarCodigoCondicion(String etiquetaV, String etiquetaF) {
        ...
        String resultado = Generador.emitirMenor(val1, val2);
