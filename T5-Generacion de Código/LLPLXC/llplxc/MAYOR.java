/*
 * MAYOR.java
 * Clase que representa la comparación mayor que (>)
 */
...
public class MAYOR extends CONDICION {
     ...
     * Constructor
     */
    public MAYOR(EXPRESION op1, EXPRESION op2) {
        super(null, null);
        this.operando1 = op1;
        this.operando2 = op2;
    }
    ...
    /*
     * Genera código para la comparación mayor que
     */
    @Override
    public void generarCodigoCondicion(String etiquetaV, String etiquetaF) {
        ...
        String resultado = Generador.emitirMayor(val1, val2);
